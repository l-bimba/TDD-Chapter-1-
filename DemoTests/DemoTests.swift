...
class DemoTests: XCTestCase {
    ...
    func testExmaple() throws {
        // Given
        let calculator = TaxCalculator()
        // When
        let netSalary = calculator.calculate(salary: 100)
        // Then
        XCTAssertEqual(netSalary, 70, "Net salary should be $70 when you subtract 30% taxes from $100")
    }
    ...
    func testPassingNegativeNumber() throws {
        ...
        do {
            ...
            "Should throw error when passing a negative salary.")
        }
    }
